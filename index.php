...
<body style="background-blend-mode: color-dodge; background-color: #dfdfdf">
  ...
  <div class="w3-row-padding w3-padding-16 w3-center" id="food">
   <div class="w3-quarter">
      <img src="onion.jpg" alt="Onion" style="width:100%">
    	 <h3>ONIONS</h3>
     
    </div>
    <div class="w3-quarter">
      <img src="http://images6.fanpop.com/image/photos/35200000/Juicy-Tomatoes-tomatoes-35204497-1800-1200.jpg" alt="Tomatoes" style="width:100%">
      <h3>TOMATOES</h3>
      
    </div>
    <div class="w3-quarter">
      <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSMNCxA2o1QQe1qasAU9eAytJP1TEKjw5H5lX8m-M-raK1TlAV4" alt="capcium" style="width:100%">
      <h3>CAPCIUM</h3>
    
      
    </div>
    <div class="w3-quarter">
      <img src="http://www.guoguiyan.com/data/out/33/70200722-carrot-wallpapers.jpeg" alt="carrots" style="width:100%">
      <h3>CARROTS</h3>
  ...
  <div class="w3-row-padding w3-padding-16 w3-center">
    <div class="w3-quarter">
      <img src="http://ak9.picdn.net/shutterstock/videos/8494759/thumb/11.jpg" alt="cabbage" style="width:100%">
      <h3>CABBAGE</h3>
      
    </div>
    <div class="w3-quarter">
      <img src="greenpeas.jpg" alt="peas" style="width:100%">
      <h3>PEAS</h3>
      
    </div>
    <div class="w3-quarter">
      <img src="bringal.jpg" alt="bringal" style="width:90%">
      <h3>BRINGAL</h3>
 ...
 <!-- <div class="w3-container w3-padding-32 w3-center" id="about">  
    <h1>About us, Fresh Produce</h1><br>
